    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header {
          background: var(--deep); padding: 2.5rem 1.5rem 2rem;
          text-align: center; border-bottom: 3px solid var(--gold); position: relative; overflow: hidden;
        }
        .header::before {
        ...
        .header-kavi {
          font-family: 'Noto Serif Tamil', serif; font-size: clamp(1rem, 3vw, 1.3rem);
          color: var(--gold-light); letter-spacing: 0.05em; margin-bottom: 0.5rem; position: relative;
        }
        .header-title {
          font-family: 'Lora', serif; font-size: clamp(2.2rem, 7vw, 4rem);
          color: #FFF8EE; line-height: 1.1; font-weight: 600; position: relative;
        }
        .header-title em { color: var(--gold); font-style: italic; }
        .header-sub {
          font-size: 0.85rem; color: var(--text-muted); margin-top: 0.75rem;
          font-weight: 300; letter-spacing: 0.08em; text-transform: uppercase; position: relative;
        }
        .ornament { text-align: center; font-size: 1.5rem; color: var(--gold); padding: 1.5rem 0 0.5rem; letter-spacing: 0.5rem; }
        .container { max-width: 900px; margin: 0 auto; padding: 0 1.25rem 3rem; }
        .section-label {
          font-size: 0.72rem; font-weight: 500; text-transform: uppercase;
          letter-spacing: 0.15em; color: var(--text-muted); text-align: center; margin-bottom: 1.5rem;
        }
        .topics-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1.25rem; }
        .topic-card {
          background: var(--card-bg); border: 1px solid var(--border); border-radius: 12px;
          padding: 1.5rem 1.25rem; text-decoration: none; display: block;
        ...
        .card-name { font-family: 'Lora', serif; font-size: 1.2rem; color: var(--deep); font-weight: 600; margin-bottom: 0.3rem; line-height: 1.3; }
        .card-count { font-size: 0.78rem; color: var(--text-muted); }
        .card-arrow { position: absolute; right: 1.25rem; top: 50%; transform: translateY(-50%); font-size: 1.2rem; color: var(--gold); opacity: 0; transition: opacity 0.18s, right 0.18s; }
      ...
      <footer>
        <div className="footer-links">
          ...
          <Link href="/analytics/" className="footer-link">🎤 Voting Analytics</Link>
